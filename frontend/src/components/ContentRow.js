                        ...
                        >
                            ...
                            <div className="w-full h-full bg-zinc-900 border border-zinc-700 p-4 flex flex-col justify-between group-hover:border-netflix-red transition-colors relative">
                                ...
                                <div>
                                    <div className="text-xs text-green-500 font-mono mb-1 flex items-center gap-2">
                                        <span className="bg-zinc-800 px-1 rounded text-[10px] text-gray-400">TARGET</span>
                                        {item.ip_address}
                                    </div>
                                    <div className="text-lg font-bold truncate text-white tracking-wide">{item.pii_data?.name || "Unknown Target"}</div>
                            ...
                            >
                                <div className="text-center">
                                    <div className="text-xs text-gray-400 mb-1">PROBABILITY SCORE</div>
