...
const DarkWebPage = () => {
    ...
    const handleSearch = (e) => {
        ...
        addLog("INITIALIZING_TOR_PROXIES...");

        setTimeout(() => addLog("CONNECTING_TO_ONION_NETWORK..."), 800);
        setTimeout(() => addLog("HANDSHAKING_WITH_NODE: [45.12.89.21]"), 1500);
        setTimeout(() => addLog(`SEARCHING_INDEXES_FOR: "${query.toUpperCase()}"`), 2200);
        setTimeout(() => addLog("TRAVERSING_DARK_NET_INDEXERS..."), 3000);
        ...
        setTimeout(() => {
            ...
            const mockHits = MOCK_LEAKS.slice(0, foundCount).map(leak => ({
                ...leak,
                matchType: Math.random() > 0.5 ? 'EXACT_MATCH' : 'FUZZY_MATCH',
                riskScore: Math.floor(Math.random() * 40) + 60
            }));
            setResults(mockHits);
            addLog(`SEARCH_COMPLETE: ${foundCount} LEADS DISCOVERED`);
        }, 4500);
    };
                ...
                <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-8 border-b border-red-900/30 pb-8">
                    <div className="space-y-2">
                        <div className="flex items-center gap-2 text-red-600 animate-pulse">
                            ...
                            <span className="text-xs font-mono font-bold tracking-[0.3em]">REDACTED_ACCESS_ONLY</span>
                        </div>
                        <h1 className="text-4xl font-heading tracking-tighter">DEEP_WEB_CRALWER <span className="text-gray-600">v4.0</span></h1>
                        <p className="max-w-xl text-gray-500 text-sm">
                            Querying live breach databases, underground forums, and dark-net markets for PII exposure.
                    ...
                    <div className="bg-red-900/10 border border-red-900/40 p-4 rounded min-w-[300px]">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-xs font-mono uppercase tracking-widest text-red-500">Node Status</span>
                        </div>
                        <div className="space-y-2 text-[10px] font-mono">
                            <div className="flex justify-between">
                                <span className="text-gray-500">TOR_CIRCUIT:</span>
                                <span className="text-green-500">ESTABLISHED</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-gray-500">ENCRYPTION:</span>
                                <span>P2P_RSA_4096</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-gray-500">IP_MASK:</span>
                                <span className="text-blue-400">104.XXX.XXX.12</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto">
                    <form onSubmit={handleSearch} className="relative group">
                        ...
                        <div className="relative bg-[#0a0a0a] border border-zinc-800 rounded-lg p-2 flex items-center">
                            ...
                            <input
                                type="text"
                                placeholder="ENTER_TARGET_NAME_EMAIL_OR_HANDLE..."
                            ...
                            >
                                {isSearching ? "SCANNING..." : "SCAN_DARKNET"}
                            </button>
                        </div>
                    </form>
                        ...
                        <AnimatePresence>
                            {isSearching && (
                                ...
                                >
                                    ...
                                    <p className="text-zinc-600 font-mono text-xs uppercase tracking-widest">Aggregating Leaked Data Shards...</p>
                                </motion.div>
                            )}
                                ...
                                >
                                    <div className="flex items-center justify-between mb-4">
                                        <h2 className="text-lg font-heading flex items-center gap-2">
                                            ...
                                            {results.length} EXPOSURE VECTORS DETECTED
                                        </h2>
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-6 mt-4 md:mt-0 w-full md:w-auto justify-end border-t md:border-t-0 border-zinc-900 pt-4 md:pt-0">
                                                    <div className="text-right">
                                                        <div className="text-[9px] text-zinc-600 uppercase mb-1">Exposure_Risk</div>
                                    ...
                                    <div className="bg-red-600/5 border border-red-900/20 p-6 rounded-lg mt-12 text-center">
                                        ...
                                        <h3 className="text-sm font-bold text-red-500 uppercase mb-2">CRITICAL_VULNERABILITY_ADVISORY</h3>
                                        <p className="text-xs text-zinc-500 max-w-lg mx-auto leading-relaxed">
                                            The data found in these breaches contains valid credentials and PII.
                                            We recommend immediate password rotation and 2FA activation for the target.
                                        </p>
                                    </div>
                                </motion.div>
                            )}
