                ...
                >
                        ...
                        <div className={`bg-[#141414] border-2 ${isGod ? 'border-red-600' : 'border-zinc-800'} rounded-lg p-6 relative overflow-hidden group`}>
                            ...
                            <div className="relative z-10 flex flex-col items-center text-center">
                                ...
                                <div className={`px-2 py-1 rounded text-[10px] font-bold mt-2 border ${isGod ? 'bg-red-900/20 border-red-600 text-red-500' : 'bg-blue-900/20 border-blue-500 text-blue-400'}`}>
                                    {isGod ? 'CLEARANCE LEVEL: GOD_MODE' : 'CLEARANCE LEVEL: ANALYST'}
                                </div>
                                ...
                                <div className="w-full mt-6 space-y-4 text-left">
                                    <div className="flex justify-between text-xs border-b border-zinc-800 pb-2">
                                        ...
                                        <span className="text-green-500 font-bold flex items-center gap-1"><Activity className="w-3 h-3" /> ACTIVE</span>
                                    </div>
                                    <div className="flex justify-between text-xs border-b border-zinc-800 pb-2">
                    ...
                    <div className="md:col-span-2 space-y-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {[
                                { label: 'OPERATIONS', val: stats.operations, icon: Terminal, color: 'text-purple-500' },
                                { label: 'WORD VECTORS', val: formatNumber(stats.data_points), icon: Database, color: 'text-blue-500' },
                                { label: 'UPTIME', val: stats.uptime, icon: Clock, color: 'text-green-500' },
                                { label: 'THREATS', val: '0', icon: AlertTriangle, color: 'text-yellow-500' },
                            ].map((stat, i) => (
                        ...
                        <div className="bg-[#141414] border border-zinc-800 rounded p-6">
                            <h3 className="text-sm font-bold text-gray-400 mb-4 flex items-center gap-2">
                                <Lock className="w-4 h-4" /> RECENT SECURITY AUDIT LOGS
                            </h3>
                            ...
                            <div className="mt-4 text-center">
                                <span className="text-[10px] text-zinc-600 uppercase">End of authorized records</span>
                            </div>
                        </div>
