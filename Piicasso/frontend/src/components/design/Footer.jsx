...
export default function Footer() {
  const cols = [
    ...
    [
      'Solutions',
      [
        ['Security teams', '/#solutions-security'],
        ['Developers', '/#solutions-dev'],
        ['Individuals', '/#solutions-ind'],
      ],
    ],
    [
      'Company',
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="v3-footer-grid"
          style={{ display: 'grid', gridTemplateColumns: '1.5fr repeat(4, 1fr)', gap: 32 }}
        >
          <div>
            <Logo />
            <p
            ...
            >
              Wordlist intelligence for the era of leaked PII. Built for red teams. Trusted by
              everyone else.
            </p>
            <div style={{ display: 'flex', gap: 8, marginTop: 16 }}>
              <span className="v3-badge">
                <span className="dot pulse" /> SOC 2 Type II
              </span>
