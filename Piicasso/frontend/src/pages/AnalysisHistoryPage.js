              ...
              >
                <div>
                  ...
                  {(analysis.vulnerabilities_found || []).length === 0 ? (
                    <div
                      style={{ fontSize: 12, color: 'var(--good)', fontFamily: 'var(--font-mono)' }}
                    >
                      ✓ No issues
                    </div>
                  ) : (
    ...
    <div style={{ padding: '40px 24px', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      >
        <div>
          ...
          <h1 className="h-display" style={{ marginBottom: '12px' }}>
            Analysis History
          </h1>
                  ...
                  return (
                    <React.Fragment key={analysis.id}>
                      <tr
                        ...
                        onMouseEnter={(e) =>
                          (e.currentTarget.style.backgroundColor = 'var(--ink-2)')
                        }
                        onMouseLeave={(e) =>
                      ...
                      >
                        ...
                        <td
                          style={{ padding: '14px 20px', fontSize: '13px', color: 'var(--fg-0)' }}
                        >
                          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                            <Clock
                              style={{ width: '14px', height: '14px', color: 'var(--fg-2)' }}
                            />
                        ...
                        <td style={{ padding: '14px 20px', fontSize: '13px', fontWeight: '600' }}>
                          <div
                            style={{
                              ...
                              alignItems: 'center',
                              gap: '6px',
                              color: analysis.breach_count > 0 ? 'var(--warn)' : 'var(--good)',
                            }}
                          >
