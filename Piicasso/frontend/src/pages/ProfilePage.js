...
const ProfilePage = () => {
  ...
  const emailChanged = editForm.email.trim().toLowerCase() !== (profile?.email || '').toLowerCase();
      ...
      >
        ...
        >
          <div style={{ marginBottom: 32 }}>
            ...
            >
              {isSecurityMode
                ? 'Classified access credentials and deployment history.'
          ...
          >
                ...
                >
                  ...
                  >
                    <div style={{ position: 'relative', flexShrink: 0 }}>
                      <ProfileAvatar user={{ ...user, profile_picture: avatarPreview }} size={64} />
                      <label
                  ...
                  {emailChanged && profile?.has_usable_password !== false && (
                    <div style={{ marginTop: 16 }}>
                      <label
                        ...
                        htmlFor="profile-email-change-password"
                      >
            ...
            <div
              style={{ display: 'flex', flexDirection: 'column', gap: 24, gridColumn: 'span 2' }}
            >
              <div
                style={{
                  display: 'grid',
              ...
              >
                {[
                  { label: 'Deployments', val: stats.operations, icon: Terminal, color: '#818cf8' },
                  {
                    ...
                    val: formatNumber(stats.data_points),
                    icon: Database,
                    color: 'var(--accent-500)',
                  },
                      ...
                      >
                        ...
                        <div style={{ marginLeft: 16 }}>
                          <div style={{ color: 'var(--fg-0)', fontSize: 14, fontWeight: 500 }}>
                            ...
                            >
                              Target:{' '}
                              {log.pii_data?.full_name ||
                                log.pii_data?.username ||
                                'Redacted Entity'}
                            </span>
                          </div>
                          <div
